...
import styles from "assets/jss/great-state/layouts/adminStyle.js";

import bgImage from "assets/img/sidebar-4.jpg";
import logo from "assets/img/greatstate.png";
...
const switchRoutes = (
  <Switch>
    ...
    <Redirect from="/public" to="/public/dashboard" />
  </Switch>
);
